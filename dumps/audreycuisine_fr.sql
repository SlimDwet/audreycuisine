...
--
-- Hôte : mariadb:3306
-- Généré le :  jeu. 23 nov. 2017 à 21:47
...
(182, 'Légumes', 'legumes-2', 1, 10, 0, NULL, '2017-11-23 21:06:24'),
(183, 'Butternut, potimarron & autres courges d\'hiver', 'butternut', 2, 1, 0, 182, '2017-11-23 21:09:22');
...
CREATE TABLE IF NOT EXISTS `Post` (
  ...
  `urlPostThumbnail` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'URL vers la photo miniature de l''article',
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_FAB8C3B32B36786B` (`title`),
...
CREATE TABLE IF NOT EXISTS `TopMenu` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_B6F5052B52EA1F09` (`order_item`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `User` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_2DA17977DBC463C4` (`full_name`)
